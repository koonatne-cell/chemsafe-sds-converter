...
# แถว hz_*/fa_* เดิมห่างกันแค่ 15pt (พอสำหรับ 1 บรรทัดสั้นๆ เท่านั้น) พอแปลเป็นไทยแล้วยาวกว่าอังกฤษเดิม
# มาก ต้องบีบฟอนต์เล็กลงมากจนอ่านยาก/ตัดจบด้วย "…" บ่อย เลยขยายเป็น 20pt ต่อแถว (พอสำหรับ ~2 บรรทัด)
# โดยดึงพื้นที่ส่วนเกินมาจาก spill/disposal ที่เดิมกว้างเกินความจำเป็น (ยังเหลือพอสำหรับข้อความยาวอยู่)
BLOCK = {
    "usage":     (100, 240),  "reactivity": (100, 269),
    "fire":      (100, 300),
    "hz_eye":    (100, 330),  "hz_oral": (100, 350),
    "hz_skin":   (100, 370),  "hz_inhale":(100, 390),
    "fa_eye":    (100, 410),  "fa_oral": (100, 430),
    "fa_skin":   (100, 450),  "fa_inhale":(100, 470),
    "spill":     (100, 490),  "disposal":(100, 530),
    "storage":   (100, 575),
}
